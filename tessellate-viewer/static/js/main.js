(function () {
  ...
  function getRenderFunction(umd) {
    if (isFunction(umd.default))
      return umd.default
    else if (isFunction(umd.exports))
      return umd.exports
    else if (umd.module && isFunction(umd.module.exports))
      return umd.module.exports
    else
      console.error('No exported function found in module.')
  }
